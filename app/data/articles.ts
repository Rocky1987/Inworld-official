...
export const articles: Article[] = [
  ...
  {
    slug: 'vehicle-tracker-esp32-4g-lte-2026',
    date: '2026年9月22日',
    readTime: '10',
    tags: ['物聯網', 'ESP32', '車聯網', '4G-LTE', '邊緣運算', '系統架構'],
    title: '邊緣到雲端：基於 ESP32 與 4G LTE 的高可靠車聯網追蹤器架構實踐',
    excerpt:
    ...
    sections: [
      {
        id: 'positioning-technology-comparison',
        number: '01',
        title: '定位技術選型：AirTag 藍牙信標 vs 衛星 GPS 車機架構',
        paragraphs: [
      ...
      {
        id: 'telecom-plan-optimization',
        number: '04',
        title: '電信方案選型與傳輸流量最佳化',
        paragraphs: [
      ...
      {
        id: 'enclosure-thermal-protection',
        number: '05',
        title: '實體防護、散熱與外殼封裝策略',
        paragraphs: [
